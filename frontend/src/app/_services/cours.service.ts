...
export class CoursService {
  ...
  public getCours() :Observable <any> {
    ...
    // dans l'espace enseignant
     ...
     // dans l'espace etudiant
     totalDoucumentsEtudiants(id :string) :Observable <any> {
      return this.http.get(`${this._coursUrl}/byClasse/numberDocuments/${id}`);
    }

    totalCoursEtudiant(id :string) :Observable <any> {
      return this.http.get(`${this._coursUrl}/byClasse/numberCors/${id}`);
    }
