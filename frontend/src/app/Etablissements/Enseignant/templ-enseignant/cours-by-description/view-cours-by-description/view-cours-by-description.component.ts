...
@Component({
  selector: 'app-view-cours-by-description',
  templateUrl: './view-cours-by-description.component.html',
  styleUrls: ['./view-cours-by-description.component.scss']
})
export class ViewCoursByDescriptionComponent implements OnInit {
id
d
cours :Cours
contenu
